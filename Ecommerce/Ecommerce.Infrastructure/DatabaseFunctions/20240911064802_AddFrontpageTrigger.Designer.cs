...
namespace Ecommerce.Infrastructure.DatabaseFunctions
{
    ...
    [Migration("20240911064802_AddFrontpageTrigger")]
    partial class AddFrontpageTrigger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Domain.Models.FrontPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("HeroBanner")
                        ...
                        .HasColumnName("hero_banner");

                    b.Property<string>("HeroBannerText")
                        .IsRequired()
                        .HasColumnType("varchar(256)")
                        .HasColumnName("hero_banner_text");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_front_pages");

                    b.HasIndex("SelectedProductId")
                        .HasDatabaseName("ix_front_pages_selected_product_id");

                    b.ToTable("front_pages", null, t =>
                        {
            ...
            modelBuilder.Entity("Ecommerce.Domain.Models.FrontPage", b =>
                {
                    b.HasOne("Ecommerce.Domain.Models.Product", "SelectedProduct")
                        .WithMany("FrontPages")
                        .HasForeignKey("SelectedProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_front_pages_products_selected_product_id");
