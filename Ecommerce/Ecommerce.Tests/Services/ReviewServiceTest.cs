...
namespace Ecommerce.Tests.Services
{
    public class ReviewServiceTest
    {
        ...
        public ReviewServiceTest()
        {
            ...
            _reviewService = new ReviewService(_mockReviewRepo.Object, _mockCache.Object);
        }
        ...
        public async Task PartialUpdateAsync_WhenCalledWithPartialUpdateDto_ReturnsGetDto()
        {
            ...
            _mockReviewRepo
                .Setup(repo => repo.UpdateAsync(It.IsAny<Review>()))
                .ReturnsAsync((Review review) => review);
            ...
            var result = await _reviewService.UpdateAsync(dto, 2);
            ...
            _mockReviewRepo.Verify(repo => repo.UpdateAsync(review), Times.Once);
        }
    }
}
