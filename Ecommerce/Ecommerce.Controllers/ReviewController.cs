...
namespace Ecommerce.Controllers
{
    ...
    public class ReviewController(IReviewService reviewService) : AppController<Review, ReviewFilterOptions, GetReviewDto, PartialUpdateReviewDto, CreateReviewDto, UpdateReviewDto>(reviewService)
    {
        ...
        async public override Task<ActionResult<GetReviewDto>> GetItem(int id)
        {
        ...
        public override async Task<ActionResult<GetReviewDto>> CreateItem([FromBody] CreateReviewDto dto)
        {
            var validationResult = new CreateReviewDtoValidator().Validate(dto);
        ...
        [SwaggerResponse(404, "The review was not found", typeof(ProblemDetails))]
        [SwaggerResponse(409, "The review already exists", typeof(ProblemDetails))]
        public override async Task<ActionResult<GetReviewDto>> PartialUpdateItem(int id, [FromBody] PartialUpdateReviewDto dto)
        {
            ...
            var updatedEntity = await _reviewService.UpdateAsync(dto, id);
        ...
        [SwaggerResponse(404, "The review was not found", typeof(ProblemDetails))]
        [SwaggerResponse(409, "The review already exists", typeof(ProblemDetails))]
        public override async Task<ActionResult<GetReviewDto>> UpdateItem(int id, [FromBody] UpdateReviewDto dto)
        {
            var validationResult = new UpdateReviewDtoValidator().Validate(dto);
            if (!validationResult.IsValid)
            {
                return BadRequest(validationResult.Errors);
            }
            var entity = await _reviewService.UpdateAsync(dto, id);
